...
```sh
ssh kolewttd@wtt.online
```
The password is Walkthetalk123$, and it 
is also the password for the root user.

If you do not prefer command-line, you can look 
for alternatives. For example try wtt.online.
